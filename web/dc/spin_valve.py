    ...
    with ui.row().classes("w-full gap-4 items-start no-wrap"):
        with ui.column().classes("flex-grow gap-1 max-w-3xl"):
            with ui.expansion("Instruments", value=True, icon="cable").classes("w-full"):
                ...
                inputs["voltmeter_visa_resource"] = text_field("Keithley 2182 (voltage)", d("voltmeter_visa_resource"))
            ...
            with ui.expansion("Gate voltage (Keithley 2400, optional)", value=True, icon="tune").classes("w-full"):
                ...
                inputs["gate_voltage_values"] = text_field(
                    ...
                    hint="Single value, or comma-separated list — one complete field sweep runs "
            ...
            with ui.expansion("Magnet & field sweep", value=True, icon="explore").classes("w-full"):
                ...
                with ui.expansion("Gaussmeter averaging (advanced)"):
                    inputs["gaussmeter_n_averages"] = num_field("Field readings averaged per point", float(d("gaussmeter_n_averages")), integer=True)
